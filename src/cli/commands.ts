...
export const COMMANDS: readonly CommandMeta[] = [
  ...
  { name: 'auto', description: '单 Agent 顺序规划并逐步深度执行（前序结果喂回下一步，/auto <任务>）' },
  { name: 'agent', description: '多 Agent 协作：规划 + 依赖调度 Worker（隔离 worktree）+ 评审' },
  ...
  { name: 'thinking', description: '切换推理/思考过程显示' },
